...
from SumikoMusic.modules.play import generate_cover
from SumikoMusic.modules.play import arq
from SumikoMusic.modules.play import cb_admin_check
from SumikoMusic.modules.play import transcode
from SumikoMusic.modules.play import convert_seconds
from SumikoMusic.modules.play import time_to_seconds
from SumikoMusic.modules.play import changeImageSize
from SumikoMusic.config import BOT_NAME as bn
from SumikoMusic.config import DURATION_LIMIT
from SumikoMusic.config import UPDATES_CHANNEL as updateschannel
from SumikoMusic.config import que
from SumikoMusic.function.admins import admins as a
from SumikoMusic.helpers.errors import DurationLimitError
from SumikoMusic.helpers.decorators import errors
from SumikoMusic.helpers.admins import get_administrators
from SumikoMusic.helpers.channelmusic import get_chat_id
from SumikoMusic.helpers.decorators import authorized_users_only
from SumikoMusic.helpers.filters import command
from SumikoMusic.helpers.filters import other_filters
from SumikoMusic.helpers.gets import get_file_name
from SumikoMusic.services.callsmusic import callsmusic
from SumikoMusic.services.callsmusic import client as USER
from SumikoMusic.services.converter.converter import convert
from SumikoMusic.services.downloaders import youtube
from SumikoMusic.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/49f521b688378718e3f29.png"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @SumikoMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/49f521b688378718e3f29.png"
